        ...
        <section class="mb-32 text-gray-800">
          <div class="flex flex-wrap">
            <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
              <h2 class="text-3xl font-bold mb-6 text-white hover:border-b-2">Contact us</h2>
              ...
              <p class="text-white mb-2">New York, 94126, United States</p>
              <p class="text-white mb-2">+ 01 234 567 89</p>
              <p class="text-white mb-2">info@gmail.com</p>
            </div>
            ...
            " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                ...
                <div class="form-group form-check text-center mb-6">
                  <input type="checkbox"
                    class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white  checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
            ...
            rounded
            shadow-md
            hover:bg-[#18a075] hover:shadow-lg
