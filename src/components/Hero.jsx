        ...
        <div className="bg-cover bg-center "
            ...
            <div className='text-white'>
                <div className='max-w-[800px]  w-full h-screen mx-auto text-center flex flex-col justify-center'>
                    ...
                    <button className='border-white border-2 rounded-md font-medium mx-auto my-6 p-2 hover:bg-white hover:text-[#00df9a] uppercase'><Link to={'/services'}>check our works</Link></button>
                </div>
            </div>
        </div>
            <Section1 />
